...
public class TicketDaoImpl implements TicketDao {
    ...
    public static final String SELECT_BY_USERID_QUERY = "SELECT * FROM tickets WHERE ID_USER = ?";
    ...
    public static synchronized TicketDaoImpl getTicketDao() {
        if (instance == null) {
    ...
    @Override
    public List<Ticket> getAllTicketsByUser(int usersId) {

        List<Ticket> ticket = new ArrayList<>();

        try (Connection connection = DataSourceFactory.getConnection();
             PreparedStatement preparedStatement = connection.prepareStatement(SELECT_BY_USERID_QUERY)) {
